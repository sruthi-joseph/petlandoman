...
analyze_colors(os.path.join(dir_path, "logo_transparent.png"))
analyze_colors(os.path.join(dir_path, "logo_white_transparent.png"))
analyze_colors(os.path.join(dir_path, "logo.png"))
